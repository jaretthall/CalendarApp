...
async function createAdminUsers() {
  ...
  // Create the full email admin
  await createUser(adminEmailFull, password);
  
  // Create the username-style admin
  ...
  console.log(`Admin: ${adminEmailFull}, Password: ${password}`);
  console.log(`Admin: ${adminUsernameEmail}, Password: ${password}`);
